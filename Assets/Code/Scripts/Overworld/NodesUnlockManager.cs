...
public class NodesUnlockManager : MonoBehaviour
{
    ...
    private void UpdateKeyNumberOnUI()
    {
        ...
        OverworldUIManager.Instance.UpdateMiniBossKeyCounterText(minibossKeyCount == true ? "MiniBoss Keys<sprite=109> 1" : "0");
        OverworldUIManager.Instance.UpdateBossKeyCounterText(minibossKeyCount == true ? "Boss Keys<sprite=109> 1" : "0");
    }
