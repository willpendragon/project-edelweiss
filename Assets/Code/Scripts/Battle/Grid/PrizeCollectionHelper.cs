...
public class PrizeCollectionHelper : MonoBehaviour
{
    ...
    public void CheckFieldPrizes(TileController destinationTile, Unit activePlayerUnit)
    {
        ...
        {
            FieldPrizeController fieldPrizeController =
                destinationTile.tileCurrentFieldPrize.GetComponent<FieldPrizeController>();
            if (fieldPrizeController != null &&
                fieldPrizeController.ItemFieldPrizeType ==
                ItemFieldPrizeType.attackPowerUp) // Using the public read-only variable from controller.
            {
                ...
                BattleSFXManager.PlaySound(SoundType.PICKUPUPGRADE);
                     ...
                     fieldPrizeController.ItemFieldPrizeType == ItemFieldPrizeType.magicPowerUp)
            {
                ...
                BattleSFXManager.PlaySound(SoundType.PICKUPUPGRADE);
                     ...
                     fieldPrizeController.ItemFieldPrizeType == ItemFieldPrizeType.PuzzleLevelKey)
            {
                     ...
                     fieldPrizeController.ItemFieldPrizeType == ItemFieldPrizeType.MinibossKey)
            {
                ...
                BattleSFXManager.PlaySound(SoundType.PICKUPMINIBOSSKEY);
                     ...
                     fieldPrizeController.ItemFieldPrizeType == ItemFieldPrizeType.BossKey)
            {
    ...
    private void UpdateCombatValues()
    {
        ...
        {
            activePlayerUnit.unitProfilePanel.GetComponent<UnitProfileController>().activeCharacterAttackPower.text =
                activePlayerUnit.unitAttackPower.ToString();
            activePlayerUnit.unitProfilePanel.GetComponent<UnitProfileController>().activeCharacterMagicPower.text =
                activePlayerUnit.unitMagicPower.ToString();
        }
    }
